        ...
        handler: async (response: any) => {
          try {
            ...
            if (verifyRes.ok) {
              ...
              // Fetch registrations and tickets
    ...
    <div className="min-h-screen bg-[#0f0519]">
      ...
      <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-purple-300 text-base mb-6">Your event tickets with QR codes for attendance</p>
          ...
          {ticketsLoading ? (
            ...
            <div className="bg-[#2d1b4e] rounded-xl shadow-lg p-12 text-center border border-purple-500/20">
              ...
              <p className="text-purple-300 text-lg">No tickets yet</p>
              <p className="text-purple-500 text-sm mt-2">Register for events below to get your tickets!</p>
            </div>
          ) : (
            <div className="space-y-6">
              {tickets.map((ticket) => (
                <div key={ticket.id} className="bg-[#2d1b4e] border border-purple-500/30 rounded-xl overflow-hidden shadow-lg hover:border-purple-500/60 hover:shadow-2xl transition-all">
                  <div className="p-6 sm:p-8">
                    <div className="flex flex-col lg:flex-row items-center gap-8">
                      ...
                      <div className="w-full lg:w-64 space-y-4">
                        <div>
                          <h3 className="text-xl font-bold text-purple-200 mb-2">{ticket.event_title}</h3>
                          <p className="text-sm text-purple-400 mb-4">
                            Ticket ID: <span className="font-mono text-purple-300">{ticket.id}</span>
                          </p>
                        </div>

                        <div className="space-y-2 bg-[#1a0b2e] rounded-lg p-4 border border-purple-500/20">
                          ...
                          <p className="text-xs text-purple-500 mt-3 pt-3 border-t border-purple-500/20">
                            Generated: {new Date(ticket.created_at).toLocaleDateString()}
                          </p>
                        </div>

                        <div className="pt-2 text-xs text-purple-400 text-center">
                          <p>Show this ticket at the venue for check-in</p>
                        </div>
                      </div>
                    </div>
                  </div>
