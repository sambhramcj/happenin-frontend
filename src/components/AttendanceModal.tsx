              ...
              <div className="flex items-center justify-between">
                ...
                <label className="flex items-center gap-2 cursor-pointer group">
                  <input
                    ...
                    className="w-5 h-5 text-purple-500 bg-purple-900/30 border-2 border-purple-500/50 rounded-md focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-[#0f0526] transition-all checked:bg-purple-500 checked:border-purple-500 cursor-pointer"
                  />
